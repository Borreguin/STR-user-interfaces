...
import {Entity, new_entity} from "../Types";
...
export class EntityCardsV2 extends React.Component<SREntityCardProps> {
    state: {
        edited: false;
    };
                ...
                {this.props.entidades.map((entidad, ix) => (
                    <div key={entidad.id_entidad}>
                        <div className="src-entity-block">
                            <div className="src-left-section">
                                <Button
                                    variant="danger"
                            ...
                            <div className="src-right-section">
                                <div className="src-summary-container">
                                    <span className="badge badge-general  ">{entidad?.n_instalaciones} instalaciones</span>
                                    <span className="badge badge-warning">{entidad?.n_bahias} bahias</span>
